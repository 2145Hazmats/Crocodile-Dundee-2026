...
public class TurretSubsystem extends SubsystemBase {
    ...
    return Commands.run(
      () -> {
        ...
        if(m_drivetrain.isAllianceBlue()) {
           setpoint = -angleToPointTo.getAsDouble() + m_drivetrain.calculateAngleToFieldPosition();
        }
  ...
  public Command turnTurretToAngleNew(DoubleSupplier angleToPointTo){
    return Commands.run(
      ()->{
        double setpoint = -angleToPointTo.getAsDouble() + m_drivetrain.calculateAngleToFieldPosition();
